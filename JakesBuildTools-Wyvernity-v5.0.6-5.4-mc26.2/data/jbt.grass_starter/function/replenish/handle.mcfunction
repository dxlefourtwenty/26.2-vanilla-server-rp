...
particle minecraft:smoke ~ ~ ~ 0.37 0.4 0.37 0 30 force
playsound minecraft:block.grass.hit player @a ~ ~ ~ 1 0.9
execute if entity @s[gamemode=!creative] run function jbt.grass_starter:replenish/durability/handle
