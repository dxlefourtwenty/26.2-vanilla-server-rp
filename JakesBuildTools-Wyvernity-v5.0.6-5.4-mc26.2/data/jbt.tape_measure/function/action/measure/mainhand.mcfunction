data modify storage jbt:temp tape.data set from entity @s SelectedItem.components."minecraft:custom_data".jbt
...
function jbt.tape_measure:action/record/mainhand with storage jbt:temp tape
